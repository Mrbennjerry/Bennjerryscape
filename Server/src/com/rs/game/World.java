...
public final class World {
	...
	public static final void spawnObjectTemporary(final WorldObject object, long time, Player player) {
		spawnObjectTemporary(object, time, false, false, player);
	}
	...
	public static final void spawnObjectTemporary(final WorldObject object, long time, final boolean checkObjectInstance, boolean checkObjectBefore, Player player) {
		final WorldObject before = checkObjectBefore ? World.getObjectWithType(object, object.getType()) : null;
		spawnObject(object);
		GameExecutorManager.slowExecutor.schedule(new Runnable() {
			@Override
