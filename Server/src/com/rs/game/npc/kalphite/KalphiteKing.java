...
public class KalphiteKing extends NPC 
{
	...
	if(!isCantInteract() && this.getCombat().getCombatDelay() == 0)	//Damage from being under KK
	{
	    for(Entity t : getPossibleTargets()) 
	    {
		if(Utils.colides(this, t)) 
		{
		    t.applyHit(new Hit(this, Utils.random(1280)+110, HitLook.REGULAR_DAMAGE));
		}
	    }
	}
	super.processNPC();
