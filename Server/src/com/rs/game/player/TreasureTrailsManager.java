...
public class TreasureTrailsManager implements Serializable {
	...
	private ClueDetails generateClueDetails(int dificulty) {
		while (true) {
			...
			if (detail.level > dificulty)
				continue;
			/*   int difference = dificulty - detail.level;
			if (difference == 0)
			return detail;
			else if (difference == 1 && Utils.random(2) == 0)
			return detail;
			else if (difference == 2 && Utils.random(4) == 0)
			return detail;
			else if (difference == 3 && Utils.random(8) == 0)
			return detail;*/
		...
		player.setCloseInterfacesEvent(new Runnable() {
			...
			public void run() {
				for (Item item : rewards) {
					...
					if ((item.getId() >= 10330 && item.getId() <= 10353) //3rd age
	...
	public static final String[] UGIS_QUOTES = new String[]
	{
		...
		"Dragonkk is playing aion right now.",
	...
	private static enum ClueDetails {
		...
		SIMPLE_L_1(EASY, SIMPLE, OBJECT, 37011, "Go to the village being attacked by trolls and search the", "drawers in one of the houses."),
		...
		{ 10, 4 }, new Item[]
		{ new Item(3329, 1), new Item(6328, 1), new Item(6328, 1) }, "Beckon in the Digsite, near", "the eastern winch.", " Bow or curtsy before you talk to me.", "Equip a pointed red and black snelm,", "snakeskin boots, and an iron pickaxe."),
		...
		EMOTE_C_7(EASY, EMOTE, TILE, 51022956, new int[]
		{ 22 }, new Item[]
		...
		{ 15, 4 }, new Item[]
		{ new Item(3333, 1), new Item(1381, 1) }, "Dance a jig under Shantay's Awning.", "Bow or curtsy before you talk to me.", "Equip a pointed blue snail", "helmet and an air staff."),
	...
	{
		new Item(8779, 20) //oak planks
		,
		new Item(556, 150),//air runes
		new Item(557, 150),//earth
		new Item(554, 150),//fire
		new Item(555, 150),//water
		new Item(7936, 150)//pure ess
		,
		new Item(1381),//staves
		new Item(1383),
		new Item(1385),
		new Item(1387)
		,
		new Item(1438),//talismans
		new Item(1440),
		new Item(1442),
		new Item(1444)
		,
		new Item(1159),//mithril armor
		new Item(1121),
		new Item(1071),
		new Item(1197)
		,
		...
		new Item(563)//law
		,
		new Item(13081),//black crossbow
		new Item(33498),//black off crossbow
		new Item(33500)//black 2h crossbow
		,
		new Item(888, 50),//mith arrows
		new Item(13083, 33)//black bolt
		,
		new Item(1299),//mithril long
		new Item(1315)//mithril 2h
		,
		new Item(1744, 10)//hard leather
	};
	...
	{ new Item(2583), new Item(2585), new Item(2587), new Item(2589), new Item(3472) //Trimmed black armour
		...
		,
		new Item(33508),
		new Item(33510)//suitcases
		//todo fallen star
	};

	private static final Item[] MEDIUM_NORMAL_REWARDS =
	{
		new Item(9183),//addy crossbow
		new Item(1301),//addy longsword
		new Item(1317)//addy 2h
		,
		new Item(890, 50),//addy arrow
		new Item(9143, 50)//addy bolts
		,
		new Item(1393),//battlestaves
		new Item(1395),
		new Item(1397),
		new Item(1399)
		,
		...
		new Item(561)//nature
		,
		new Item(8781, 4)//teak planks
		,
		new Item(1161),
		new Item(1073),
		new Item(1123),
		new Item(1199)//addy armor
		,
		new Item(1099),//green dhide
		new Item(1135)
		,
		new Item(554, 300),//runes
		new Item(555, 300),
		new Item(556, 300),
		new Item(557, 300),
		new Item(558, 300)
		,
		new Item(7937, 300)//pure ess
		,
		new Item(1754, 5)//green dhide
	};
	...
	private static final Item[] HARD_NORMAL_REWARDS =
	{
		...
		new Item(1201)
		,
		new Item(892, 150) //runite arrows
		,
		new Item(8783, 24) //mahogany planks
		,
		new Item(2497),//black dhide
		new Item(2503)
		,
		new Item(1401),//mystic staves
		new Item(1403),
		new Item(1405),
		new Item(1407)
		,
		new Item(563, 75),//runes
		new Item(561, 75),
		new Item(565, 75),
		new Item(9075, 75)
		,
		new Item(1748, 5),//black dhide
	};
	...
	{ new Item(2623), new Item(2625), new Item(2627), new Item(2629), new Item(3477) //Trimmed rune armour
		...
		,
		new Item(10282),//comp bows
		new Item(10284)
		,
		new Item(33502)//fury(t)
		,
		new Item(33294),//dyes and capes
		new Item(33296),
		new Item(33516),
		new Item(33518),
		new Item(33520)
	...
	{ 
		new Item(5303, 2),//herb seeds
		new Item(5302, 2)
		,
		new Item(1445, 8)//water talisman
		,
		new Item(2354, 5)//rune bar
		,
		new Item(24373, 15)//royal dhide
		,
		new Item(1632, 2)//dstone
		,
		new Item(8783, 40)//mahog plank
		,
		new Item(1127)//rune pl8
		,
		new Item(5289),//seeds
		new Item(5288),
		new Item(5315)
		,
		new Item(3025, 9),//potions
		new Item(2453, 9),
		new Item(2435, 9)
		,
		new Item(10163, 15)//swamp lizards
		,
		new Item(238, 10)//unicorn horn
		,
		new Item(9194, 12)//onyx bolt tip
		,
		new Item(1392, 8)//battlestaff
		,
		new Item(1149)//dhelm
	};

	private static final Item[] ELITE_RARE_REWARDS =
	{ new Item(19308), new Item(19311), new Item(19314), new Item(19317), new Item(19320) //Third-age druidic equipment
		,
		new Item(19413),
		new Item(19416),
		new Item(19419),
		...
		,
		new Item(33518),//capes
		new Item(33520)
		,
		new Item(28547),//triskelion frag
		new Item(28548),
		new Item(28549)
		,
		new Item(33294),//dyes
