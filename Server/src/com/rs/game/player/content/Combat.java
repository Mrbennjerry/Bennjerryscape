...
public final class Combat {
	...
	public static void giveXP(Entity from, double totalXP) {
		...
		for(Entity source : dmgReceived.keySet()) {
			...
			double rawXp = dmgDealt * totalXP / totalDmgReceived;
			double receivedXP = rawXp * Settings.COMBAT_RATE;
	...
	public static boolean hasAntiDragProtection(Entity target) {
		...
		return shieldId == 1540 || shieldId == 11283 || shieldId == 11284 || shieldId == 16933 || shieldId == 25558
			|| shieldId == 25559 || shieldId == 25561 || shieldId == 25562;
	}
