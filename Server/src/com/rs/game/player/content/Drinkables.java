...
public final class Drinkables {
	...
	public static final int VIAL = 229, FLASK = 23191, DUNGEONEERING_VIAL = 17490;
	...
	public static boolean drink(Player player, Item item, int slot) {
		...
		player.setNextAnimationNoPriority(new Animation((player.getCombatDefinitions().isCombatStance() && !player.isLegacyMode()) ? 18003 : 18000));
