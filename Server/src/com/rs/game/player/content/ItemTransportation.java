...
public class ItemTransportation {
	...
	{ new WorldTile(2878, 3558, 0), new WorldTile(2880, 3559, 0), new WorldTile(2519, 3571, 0), new WorldTile(2970, 9679, 0), new WorldTile(2886, 4377, 0), new WorldTile(3250, 9517, 2) },
	...
	{ "Troll Invasion", "Burthrope Games Room", "Barbarian Outpost", "Gamers' Grotto", "Corporeal Beast", "Tears of Guthix"/*, "Nowhere"*/ },
	...
	{ "Sumona's Lair", "Slayer Tower", "Freminek Slayer Dungeon", "Tarn's Lair"/*, "Nowhere"*/ },
	{ "Main Plaza", "Fight Pits", "Fight Caves", "Fight Kiln"/*, "Nowhere"*/ },
	{ "Lletya"/*, "Nowhere"*/ },
	{ "Lumber Yard"/*, "Nowhere"*/ },
	{ "Nardah"/*, "Nowhere"*/ },
	{ "Tai Bwo Wannai"/*, "Nowhere"*/ },
	{ "Bandit camp"/*, "Nowhere"*/ },
	{ "Pollnivneach"/*, "Nowhere"*/ },
	...
	{ 2566, 3867, 1706, 10362, 11113, 11126, 11190, 20653, 13288, 23643, 6102, 19480, 19479, 19476, 19475, 19475, 19478, 19477, 19760, -1 };
	...
	public static boolean transportationDialogue(Player player, Item item, boolean removeCharge) {
		int index = getIndex(item);
		int type = checkAll(player, item, index, 0, 1);
		if (type != 2)
			return type == 1;
		player.getDialogueManager().startDialogue("Transportation", TELEPORT_NAMES[index], item, removeCharge);
		return true;
	}
