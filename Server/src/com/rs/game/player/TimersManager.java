...
public class TimersManager implements Serializable {
	...
	public static enum RecordKey {
		...
		ABYSSAL_DEMON(20, false, false, 29),
		ABERRANT_SPECTRES(21, false, false, 29),
		AIRUT(22, false, false, 29),
		AQUANITES(23, false, false, 29),
		ASCENSION_CREATURES(24, false, false, 29),
		AUTOMATONS(25, false, false, 29),
		BLOODVELDS(26, false, false, 29),
		DARK_BEASTS(27, false, false, 29),
		DESERT_STRYKE(28, false, false, 29),
		DUST_DEVIL(29, false, false, 29),
		JUNGLE_STRYKE(30, false, false, 29),
		GARGOYLE(31, false, false, 29),
		GLACORS(32, false, false, 29),
		ICE_STRYKE(33, false, false, 29),
		KAL_DEMON(34, false, false, 29),
		MUSPAH(35, false, false, 29),
		MUTATED_JADINKOS(36, false, false, 29),
		NECHRYAEL(37, false, false, 29),
		NIHIL(38, false, false, 29),
		POLYPORE(39, false, false, 29),
		SKEL_WYVERN(40, false, false, 29),
		SPIRIT_MAGE(41, false, false, 29),
		TERROR_DOG(42, false, false, 29),
		TORMENTED(43, false, false, 29),
		TORTOISE(44, false, false, 29),
		EDIMMU(45, false, false, 29);
	...
	/*	private BossRecord(int totalKills, int totalHmKills, int fastestKill) {
			this.totalKills = totalKills;
			this.totalHmKills = totalHmKills;
			this.fastestKill = fastestKill;
		}*/
	}
	...
	public void increaseKills(RecordKey key, boolean hm) {
		if (isActive() || key.hasFastestKill)  //shouldnt be used with this if a timer boss
			return;
		BossRecord record = getRecord(key);
		if(record == null) {
			record = new BossRecord();
			this.record.put(key, record);
			player.getPackets().sendGameMessage("1");
		}
		if(key.hasHM && hm)
			record.totalHmKills++;
		else
			record.totalKills++;
		player.getPackets().sendGameMessage("2");
		sendBossKills();
	}
	...
	public void sendSlayerCreatureKills() {
		...
		BossRecord abyssalDemonRecord = getRecord(RecordKey.ABYSSAL_DEMON);
		player.getVarsManager().sendVarBit(22935, abyssalDemonRecord != null ? abyssalDemonRecord.totalKills : 0);//Abyssal Demons
	...
	//ignore this. not related to code. only use removetimer and sendtimer methods
