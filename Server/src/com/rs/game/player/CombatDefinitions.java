...
public final class CombatDefinitions implements Serializable {
	...
	public void refreshBonuses() {
		...
		for (int i = 0; i < player.getEquipment().getItems().getSize(); i++) {
			...
			if (item == null || (item.getId() >= 22346 && item.getId() <= 22348 && !(player.getControlerManager().getControler() instanceof DTControler)))
				continue;
			ItemDefinitions defs = item.getDefinitions();
			int type = getType(i);
				...
				if (i == Equipment.SLOT_WEAPON) {
					...
					if (mainHandType == Combat.RANGE_TYPE && weapon.getDefinitions().getCSOpcode(2940) == 0) {
						...
						if (player.getEquipment().hasTwoHandedWeapon())
							...
							Item offhand = player.getEquipment().getItem(Equipment.SLOT_SHIELD);
							abilityDamage += offhand == null ? 0 : (int) ((mainHandType == Combat.RANGE_TYPE ? offhand.getDefinitions().getRangedLevel() : offhand.getDefinitions().getAttackLevel()) * 96) / 2;
						}
					}
	...
	public void refreshShowCombatModeIcon() {
		player.getVarsManager().sendVarBit(21686, !player.isLegacyMode() && showCombatModeIcon ? 1 : 0);
	}
	...
	public void refreshAllowAbilityQueueing() {
		player.getVarsManager().sendVarBit(21684, !player.isLegacyMode() && allowAbilityQueueing ? 0 : 1);
	}
	...
	private void updateTargetBuffs(boolean update) {
		...
		update |= player.getVarsManager().sendVarBit(1956, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 1) && player.getSkills().getLevel(Skills.PRAYER) < 13 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1957, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 1) && player.getSkills().getLevel(Skills.PRAYER) < 31 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1958, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 1) && player.getSkills().getLevel(Skills.PRAYER) >= 31 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1959, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 2) && player.getSkills().getLevel(Skills.PRAYER) < 16 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1960, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 2) && player.getSkills().getLevel(Skills.PRAYER) < 34 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1961, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 2) && player.getSkills().getLevel(Skills.PRAYER) >= 34 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1962, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 7) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1963, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 8) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1964, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 9) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1965, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 11) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1966, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 12) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1967, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 13) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1968, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 14) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1969, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 15) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1970, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 16) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1971, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 3) && player.getSkills().getLevel(Skills.PRAYER) < 26 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1972, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 3) && player.getSkills().getLevel(Skills.PRAYER) < 44 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1973, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 3) && player.getSkills().getLevel(Skills.PRAYER) >= 44 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1974, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 5) && player.getSkills().getLevel(Skills.PRAYER) < 27 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1975, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 5) && player.getSkills().getLevel(Skills.PRAYER) < 45 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1976, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 5) && player.getSkills().getLevel(Skills.PRAYER) >= 45 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1977, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 4) && player.getSkills().getLevel(Skills.PRAYER) < 26 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1978, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 4) && player.getSkills().getLevel(Skills.PRAYER) < 44 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1979, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 4) && player.getSkills().getLevel(Skills.PRAYER) >= 44 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1980, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 6) && player.getSkills().getLevel(Skills.PRAYER) < 27 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1981, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 6) && player.getSkills().getLevel(Skills.PRAYER) < 45 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1982, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 6) && player.getSkills().getLevel(Skills.PRAYER) >= 45 ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1983, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 10) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1984, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 17) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1985, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(0, 19) ? 1 : 0);
		...
		update |= player.getVarsManager().sendVarBit(1992, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 7) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1993, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 20) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1994, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 16) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1995, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 18) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1996, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 26) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1997, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 27) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1998, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 0) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(1999, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 1) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2000, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 2) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2001, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 4) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2002, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 6) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2003, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 9) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2004, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 10) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2005, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 11) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2006, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 12) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2007, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 13) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2008, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 14) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2009, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 15) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2010, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 17) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2011, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 19) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2013, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 21) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2014, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 22) ? 1 : 0);
		update |= player.getVarsManager().sendVarBit(2015, targetPlayer != null && targetPlayer.getPrayer().usingPrayer(1, 23) ? 1 : 0);
	...
	public int getSkillAccuracy(boolean offhand) {
		...
		return (int) (Combat.getAccuracy(player.getSkills().getLevel(handType == Combat.MAGIC_TYPE ? Skills.MAGIC : handType == Combat.RANGE_TYPE ? Skills.RANGE : Skills.ATTACK)) * 1);
	}
