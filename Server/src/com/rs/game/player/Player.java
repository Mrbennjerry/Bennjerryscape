...
public class Player extends Entity {
    ...
    public boolean flickeringBoon = false;
    ...
    //grim
    private boolean talkedWithGrim;

    public boolean isTalkedWithGrim() {
	return talkedWithGrim;
    }

    public void setTalkedWithGrim(boolean talkedWithGrim) {
	this.talkedWithGrim = talkedWithGrim;
    }

    public int grimPoints = 0;

    public int getGrimPoints() {
	return grimPoints;
    }
    
    public void setGrimPoints(int grimPoints) {
	this.grimPoints = grimPoints;
    }

    public boolean hasTask = false;
    public int slayerAmount = 0;
    private GrimTask task;

    public void setTask(GrimTask task) {
	this.task = task;
    }

    public GrimTask getTask() {
	return task;
    }
    ...
    public boolean editChillBlastMinig;

    public boolean SamuraiCooking;
    public boolean editSamuraiCooking;
