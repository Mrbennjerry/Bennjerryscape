...
public class TanningD extends Dialogue {
	...
	public void start() {
		...
		isCanfis = npcId == 1041;
		SkillsDialogueOld.sendSkillsDialogue(player, SkillsDialogueOld.MAKE, "How many hides would you like to tan?<br>Choose a number, then click the hide to begin.", 28, PRODUCT, new ItemNameFilter() {
			int count = 0;
