...
public class CombinationsD extends Dialogue {
	...
	public enum Combinations {
		...
		BACON_STACK(34, 1, new Item(28635), new Item(28636), COMBINE, new Item(28635)),
		
		BACON_PILE(34, 1, new Item(28636), new Item(28637), COMBINE, new Item(28636)),
		
		BACON_HEAP(44, 1, new Item(28637), new Item(28638), COMBINE, new Item(28637)),
		
		BACON_MOUND(54, 1, new Item(28638), new Item(28639), COMBINE, new Item(28638)),
		
		PORK_PIE(1, 0, new Item(28635, 3), new Item(28655), COMBINE, new Item(2315)),
		;
