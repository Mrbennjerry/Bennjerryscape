...
public class Cooking extends Action {
	...
	public static enum Cookables {
		...
		BACON(new Item(28635), 14, 34, 68, new Item(28650), new Item(28640), false, false),
		
		BACON_STACK(new Item(28636), 24, 44, 98, new Item(28651), new Item(28642), false, false),
		
		BACON_PILE(new Item(28637), 34, 54, 108, new Item(28652), new Item(28644), false, false),
		
		BACON_HEAP(new Item(28638), 44, 64, 138, new Item(28653), new Item(28646), false, false),
		
		BACON_MOUND(new Item(28639), 54, 74, 158, new Item(28654), new Item(28648), false, false),
		
		PORK_PIE(new Item(28655), 74, 94, 210, new Item(28658), new Item(28656), false, false),
		;
	...
	public boolean start(Player player) {
		...
		if (!process(player))
			return false;
		player.getPackets().sendGameMessage("You attempt to cook the " + cook.getProduct().getDefinitions().getName().toLowerCase() + ".", true);
	...
	public int processWithDelay(Player player) {
		...
		if ((player.getSkills().getLevel(Skills.COOKING) >= cook.getBurningLvl()) ? false : isBurned(cook, player)) {
			...
			if (cook.getBurntId().getId() == 1781)
				player.getPackets().sendGameMessage("You burn the " + item.getName() + " to soda ash.");
			else
