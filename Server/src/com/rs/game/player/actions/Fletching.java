...
public class Fletching extends Action {
	...
	public static enum Fletch {
		...
		{ 1, 5, 10, 9 }, new double[]
		{ 5, 5, 10, 6 }, new Animation(6702)),//old 6702

		STRUNG_SHORT_BOW(50, 1777, new int[]
		{ 841 }, new int[]
		{ 5 }, new double[]
		{ 5 }, new Animation(24945)),//old 6678

		STRUNG_LONG_BOW(48, 1777, new int[]
		{ 839 }, new int[]
		{ 10 }, new double[]
		{ 10 }, new Animation(24952)),//old 6684

		OAK_BOW(1521, 946, new int[]
		{ 54, 56, 9442 }, new int[]
		{ 20, 25, 24 }, new double[]
		{ 16.5, 25, 16 }, new Animation(6702)),//old 6702

		STRUNG_OAK_SHORT_BOW(54, 1777, new int[]
		{ 843 }, new int[]
		{ 20 }, new double[]
		{ 16.5 }, new Animation(24946)),//old 6679

		STRUNG_OAK_LONG_BOW(56, 1777, new int[]
		{ 845 }, new int[]
		{ 25 }, new double[]
		{ 25 }, new Animation(24953)),//old 6685

		WILLOW_BOW(1519, 946, new int[]
		{ 60, 58, 9444 }, new int[]
		{ 35, 40, 39 }, new double[]
		{ 33.3, 41.5, 22 }, new Animation(6702)),//old 6702

		STRUNG_WILLOW_SHORT_BOW(60, 1777, new int[]
		{ 849 }, new int[]
		{ 35 }, new double[]
		{ 33.3 }, new Animation(24947)),//old 6680

		STRUNG_WILLOW_LONG_BOW(58, 1777, new int[]
		{ 847 }, new int[]
		{ 40 }, new double[]
		{ 41.5 }, new Animation(24954)),//old 6686

		MAPLE_BOW(1517, 946, new int[]
		{ 64, 62, 9448 }, new int[]
		{ 50, 55, 54 }, new double[]
		{ 50, 58.3, 32 }, new Animation(6702)),//old 6702

		STRUNG_MAPLE_SHORT_BOW(64, 1777, new int[]
		{ 853 }, new int[]
		{ 50 }, new double[]
		{ 50 }, new Animation(24948)),//old 6681

		STRUNG_MAPLE_LONG_BOW(62, 1777, new int[]
		{ 851 }, new int[]
		{ 55 }, new double[]
		{ 58.3 }, new Animation(24955)),//old 6687

		YEW_BOW(1515, 946, new int[]
		{ 68, 66, 9452 }, new int[]
		{ 65, 70, 69 }, new double[]
		{ 67.5, 75, 50 }, new Animation(24938)),//old 6702

		STRUNG_YEW_SHORT_BOW(68, 1777, new int[]
		{ 857 }, new int[]
		{ 65 }, new double[]
		{ 67.5 }, new Animation(24949)),//old 6682

		STRUNG_YEW_LONG_BOW(66, 1777, new int[]
		{ 855 }, new int[]
		{ 70 }, new double[]
		{ 75 }, new Animation(24956)),//old 6688

		MAGIC_BOW(1513, 946, new int[]
		{ 72, 70 }, new int[]
		{ 80, 85 }, new double[]
		{ 83.25, 91.5 }, new Animation(24939)),//old 6702

		STRUNG_MAGIC_SHORT_BOW(72, 1777, new int[]
		{ 861 }, new int[]
		{ 80 }, new double[]
		{ 83.25 }, new Animation(24950)),//old 6683

		STRUNG_MAGIC_LONG_BOW(70, 1777, new int[]
		{ 859 }, new int[]
		{ 85 }, new double[]
		{ 91.5 }, new Animation(24957)),//old 6689
