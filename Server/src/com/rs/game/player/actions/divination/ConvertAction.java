...
public class ConvertAction extends Action {
	...
	// inter cs 357
	private static final double[] EXPERIENCE = { 45.0D, 42.0D, 38.0D, 35.0D, 33.5D, 32.0D, 25.0D,
		19.0D, 12.0D, 7.0D, 5.0D, 4.0D, 45.0D, 42.0D, 38.0D, 35.0D, 33.5D, 32.0D, 25.0D,
		19.0D, 12.0D, 7.0D, 5.0D, 4.0D, 3.0D};
	private static final int[] MEMORIES = {
		/*Enriched Memories*/29406, 29405, 29404, 29403, 31327, 29402, 29401, 29400, 29399, 29398, 29397, 29396,
		/*Regular Memories*/29395, 29394, 29393, 29392, 31326, 29391, 29390, 29389, 29388, 29387, 29386, 29385, 29384 };
	private static final int[] ENERGY = {
		29324,29323, 29322, 29321, 31312, 29320, 29319, 29318, 29317, 29316, 29315, 29314, 29313,
	};
	...
	public int processWithDelay(Player player) {
		...
		if (enriched) // Enriched double's all exp gain.
			exp *= 2;
		if (MEMORIES[nextMemory] == 29384 && player.flickeringBoon == true)
		    	exp *= 1.10;
