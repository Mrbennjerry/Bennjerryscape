    ...
    public class DivineFishing extends Action {
            ...
            public DivineFishing(DivineFishingSpots spot, int x, int y,int plane, Player owner) {
        	this.owner = owner;
                    this.spot = spot;
            ...
            private void addFish(Player player) {
                    ...
                    if (bigFish == 1) {
                            ...
                            player.getPackets().sendGameMessage("You catch an enormous fish!");
                    } else {
                             //Player owner =  null; //= spot.getOwner();
                                    if(player == owner) {
                                            ...
                                            owner.getPackets().sendGameMessage(""+player.getUsername()+" caught some "+fishName+" for you.");       
                                            }
                                            player.getInventory().addItem(fish);
                                            player.getPackets().sendGameMessage("You mine some " + fishName + ".", true);
                                            }
                            //player.getInventory().addItem(fish);
