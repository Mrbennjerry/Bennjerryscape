...
public final class Woodcutting extends Action {
	...
	public static enum TreeDefinitions {
		...
		ELDER(90, 325, 29556, 170, 21, -1, 121, 10),
		
		CRYSTAL(94, 434.5, -1, 180, 21, 87533, 121, 10),
	...
	public enum HatchetDefinitions {
		...
		BRONZE(1351, 1, 1, 21668),

		IRON(1349, 5, 2, 21667),

		STEEL(1353, 5, 3, 21666),

		BLACK(1361, 11, 4, 21665),

		MITHRIL(1355, 21, 5, 21664),

		ADAMANT(1357, 31, 7, 21663),

		RUNE(1359, 41, 10, 21662),

		DRAGON(6739, 61, 13, 21669),

		INFERNO(13661, 61, 13, 10251),
		
		CRYSTAL(32645, 71, 16, 25169);
