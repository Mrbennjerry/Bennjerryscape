...
public class Fishing extends Action {
    ...
    private int BIGNET = 24932, CRAB = 24931, NET = 24930, CAGE = 24929,
	    URN = 24933, BAIT = 24935;
	...
	CAVEFISH_SHOAL(8841, 1, 307, 313, new Animation(24935), Fish.CAVE_FISH),

	ROCKTAIL_SHOAL(8842, 1, 307, 15263, new Animation(24935), Fish.ROCKTAIL),

	NET(327, 1, 303, -1, new Animation(24930), Fish.SHRIMP, Fish.ANCHOVIES), LURE(328, 1, 309, 314,
		new Animation(622), Fish.TROUT, Fish.SALMON), LURE2(329, 1, 309, 314, new Animation(622), Fish.TROUT,
			Fish.SALMON), LURE3(317, 1, 309, 314, new Animation(622), Fish.TROUT, Fish.SALMON),

	BAIT(328, 2, 307, 313, new Animation(24935), Fish.PIKE),

	BAIT2(317, 2, 307, 313, new Animation(24935), Fish.PIKE), BAIT3(329, 2, 307, 313, new Animation(622), Fish.PIKE),

	CAGE(6267, 1, 301, -1, new Animation(24929), Fish.LOBSTER),

	CAGE2(312, 1, 301, -1, new Animation(24929), Fish.LOBSTER), HARPOON(312, 2, 311, -1, new Animation(618),
		Fish.TUNA, Fish.SWORDFISH, Fish.SHARK),

	BIG_NET(313, 1, 305, -1, new Animation(24932), Fish.MACKEREL, Fish.COD, Fish.BASS, Fish.SEAWEED, Fish.OYSTER),

	HARPOON2(313, 2, 311, -1, new Animation(618), Fish.TUNA, Fish.SWORDFISH, Fish.SHARK),

	NET2(952, 1, 303, -1, new Animation(24930), Fish.SHRIMP);
