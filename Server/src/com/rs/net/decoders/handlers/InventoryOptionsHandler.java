...
public class InventoryOptionsHandler {
	...
	public static void handleItemOption1(final Player player, final int slotId, final int itemId, Item item) {
	    int craftId = item.getId();
		if (player.isLocked() || player.isStunned() || player.getEmotesManager().isDoingEmote())
			return;
		if (Drinkables.drink(player, item, slotId))
			return;
		//if (DivineLocations.isPlacingLocation(player, itemId))
		//	return;
		player.stopAll(false);
		...
		//	return;
		//}
		else if (Crafting.isCrafting(player, craftId))
			return;
		 ...
		 */
			...
			DivinePlacing.placeDivinePre(player, itemId, 87285, 34107, 1, 14);	
		}
		else if (itemId == 29295) {
			DivinePlacing.placeDivinePre(player, itemId, 87286, 57572, 15, 14);	
		}
		else if (itemId == 29296) {
			DivinePlacing.placeDivinePre(player, itemId, 87287, 87266, 30, 14);
		}
		else if (itemId == 29297 ) {
			DivinePlacing.placeDivinePre(player, itemId, 87288, 87267, 55, 14);	
		}
		else if (itemId == 29298) {
			DivinePlacing.placeDivinePre(player, itemId, 87289, 87268, 70, 14);
		}
		else if (itemId == 29299) {
			DivinePlacing.placeDivinePre(player, itemId, 87290, 87269, 85, 14);
		}
		/**
		 * Divine fish
		 */
		else if (itemId == 31080) {
			DivinePlacing.placeDivinePre(player, itemId, 90232, 90223, 10, 10);
		}
		else if (itemId == 31081) {
			DivinePlacing.placeDivinePre(player, itemId, 90233, 90224, 10, 10);
		}
		else if (itemId == 31082) {
			DivinePlacing.placeDivinePre(player, itemId, 90234, 90225, 20, 10);
		}
		else if (itemId == 31083) {
			DivinePlacing.placeDivinePre(player, itemId, 90235, 90226, 30, 10);
		}
		else if (itemId == 31084) {
			DivinePlacing.placeDivinePre(player, itemId, 90236, 90227, 40, 10);
		}
		else if (itemId == 31085) {
			DivinePlacing.placeDivinePre(player, itemId, 90237, 90228, 50, 10);
		}
		else if (itemId == 31086) {
			DivinePlacing.placeDivinePre(player, itemId, 90238, 90229, 76, 10);
		}
		else if (itemId == 31087) {
			DivinePlacing.placeDivinePre(player, itemId, 90239, 90230, 85, 10);
		}
		else if (itemId == 31088) {
			DivinePlacing.placeDivinePre(player, itemId, 90240, 90231, 90, 10);
		}
		/**
		 * Divine tree
		 */
		else if (itemId == 29304) {
			DivinePlacing.placeDivinePre(player, itemId, 87295, 87274, 1, 8);
		}
		else if (itemId == 29305) {
			DivinePlacing.placeDivinePre(player, itemId, 87296, 87275, 15, 8);
		}
		else if (itemId == 29306) {
			DivinePlacing.placeDivinePre(player, itemId, 87297, 87276, 30, 8);
		}
		else if (itemId == 29307) {
			DivinePlacing.placeDivinePre(player, itemId, 87298, 87277, 45, 8);
		}
		else if (itemId == 29308) {
			DivinePlacing.placeDivinePre(player, itemId, 87299, 87278, 60, 8);
		}
		else if (itemId == 29309) {
			DivinePlacing.placeDivinePre(player, itemId, 87300, 87279, 75, 8);
		}
		/**
		 * Divine hunt
		 */
		else if (itemId == 29300) {
			DivinePlacing.placeDivinePre(player, itemId, 87291, 87270, 1, 21);
		}
		else if (itemId == 29301) {
			DivinePlacing.placeDivinePre(player, itemId, 87292, 87271, 1, 21);
		}
		else if (itemId == 29302) {
			DivinePlacing.placeDivinePre(player, itemId, 87293, 87272, 23, 21);
		}
		else if (itemId == 29303) {
			DivinePlacing.placeDivinePre(player, itemId, 87294, 87273, 53, 21);
		}
		/**
		 * Divine herb
		 */
		else if (itemId == 29310) {
			DivinePlacing.placeDivinePre(player, itemId, 87301, 87280, 9, 15);
		}
		else if (itemId == 29311) {
			DivinePlacing.placeDivinePre(player, itemId, 87302, 87281, 44, 15);
		}
		else if (itemId == 29312) {
			DivinePlacing.placeDivinePre(player, itemId, 87303, 87282, 67, 15);
		}
		/**
		 * Divine end
		 */
	...
	public static void handleInterfaceOnInterface(final Player player, InputStream stream) {
		...
		if ((interfaceId == Inventory.INVENTORY_INTERFACE || interfaceId == Inventory.INVENTORY_INTERFACE_2) && interfaceId == interfaceId2 && !player.getInterfaceManager().containsInventoryInter()) {
			...
			//	return;
			//}
			else if (Crafting.isCrafting(player, itemUsed, usedWith))
				return;
	...
	public static void handleItemOption6(Player player, int slot, int itemId, Item item) {
		...
		if ((item.getDefinitions().containsOption("Rub") || item.getDefinitions().containsOption("Cabbage-port")) && ItemTransportation.transportationDialogue(player, item, true))
		    ...
		    player.getPackets().sendGameMessage("You empty the water from the vial.", true);
		}
		else if (itemId == 995) {
			if (player.isCanPvp()) {
		...
		else if (itemId == 11283 || itemId == 25561 || itemId == 25558)
