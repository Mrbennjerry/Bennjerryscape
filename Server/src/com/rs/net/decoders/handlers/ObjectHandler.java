...
import com.rs.game.player.actions.divination.DivineFishing;
import com.rs.game.player.actions.divination.DivineFishing.DivineFishingSpots;
import com.rs.game.player.actions.divination.DivineHerblore;
import com.rs.game.player.actions.divination.DivineHerblore.DivineHerbsSpots;
import com.rs.game.player.actions.divination.DivineHunting;
import com.rs.game.player.actions.divination.DivineHunting.DivineHuntingSpots;
		...
		player.setRouteEvent(new RouteEvent(object, new Runnable() {
			...
			public void run() {
				...
				// start falador mininig
					...
					player.getPackets().sendGameMessage("Your ores are gone... everyone last one!");
				else if (id == 5906) {
					...
					switch (objectDef.name.toLowerCase()) {
						...
						case "firepit":
							if (objectDef.containsOption(0, "Cook-at")) {
							    Item item = Cooking.getCook(player).getRawItem();
						...
						case "crystal":
							if (objectDef.containsOption(0, "Chop down"))
								player.getActionManager().setAction(new Woodcutting(object, TreeDefinitions.CRYSTAL));
							break;
							// Woodcutting end
						case "divine bronze rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_BRONZE_ORE,object.getOwner()));
						         break;
						case "divine runite rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_RUNE_ORE,object.getOwner()));
						         break;
						case "divine adamantite rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_ADAMANTITE_ORE,object.getOwner()));
						         break;
						case "divine mithril rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_MITHRIL_ORE,object.getOwner()));
						         break;
						case "divine coal rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_COAL_ORE,object.getOwner()));
						         break;
						case "divine iron rock":
						         player.getActionManager().setAction(new com.rs.game.player.actions.divination.DivineMining
						           (object, com.rs.game.player.actions.divination.DivineMining.RockDefinitions.DIVINE_IRON_ORE,object.getOwner()));
						         break;
						case "divine crayfish bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_CRAYFISH, x, y, plane, object.getOwner()));
							 break;
						case "divine herring bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_HERRING, x, y, plane, object.getOwner()));
							 break;
						case "divine trout bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_TROUT, x, y, plane, object.getOwner()));
							 break;
						case "divine salmon bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_SALMON, x, y, plane, object.getOwner()));
							 break;
						case "divine lobster bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_LOBSTER, x, y, plane, object.getOwner()));
							 break;
						case "divine swordfish bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_SWORDFISH, x, y, plane, object.getOwner()));
							 break;
						case "divine shark bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_SHARK, x, y, plane, object.getOwner()));
							 break;
						case "divine cavefish bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_CAVEFISH, x, y, plane, object.getOwner()));
							 break;
						case "divine rocktail bubble":
						    	player.getActionManager().setAction(new DivineFishing(DivineFishingSpots.DIVINE_ROCKTAIL, x, y, plane, object.getOwner()));
							 break;
						case "divine magic tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_MAGIC, object.getOwner()));
							break;
						case "divine tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_NORMAL, object.getOwner()));
							break;
						case "divine oak tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_OAK, object.getOwner()));
							break;
						case "divine willow tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_WILLOW, object.getOwner()));
							break;
						case "divine maple tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_MAPLE, object.getOwner()));
							break;
						case "divine yew tree":		
							if (objectDef.containsOption(0, "Chop"))
								player.getActionManager().setAction(
										new DivineWoodcutting(object,
												DivineTreeDefinitions.DIVINE_YEW, object.getOwner()));
							break;
						case "divine kebbit burrow":
						    player.getActionManager().setAction(new DivineHunting(DivineHuntingSpots.DIVINE_KEBBIT_BURROW, x, y, plane, object.getOwner()));
							 break;
						case "divine bird snare":
						    player.getActionManager().setAction(new DivineHunting(DivineHuntingSpots.DIVINE_BIRD_SNARE, x, y, plane, object.getOwner()));
							 break;
						case "divine deadfall trap":
						    player.getActionManager().setAction(new DivineHunting(DivineHuntingSpots.DIVINE_DEADFALL_TRAP, x, y, plane, object.getOwner()));
							 break;
						case "divine box trap":
						    player.getActionManager().setAction(new DivineHunting(DivineHuntingSpots.DIVINE_BOX_TRAP, x, y, plane, object.getOwner()));
							 break;
						case "divine herb patch i":
						    player.getActionManager().setAction(new DivineHerblore(DivineHerbsSpots.DIVINE_HERB_I, x, y, plane, object.getOwner()));
							 break;
						case "divine herb patch ii":
						    player.getActionManager().setAction(new DivineHerblore(DivineHerbsSpots.DIVINE_HERB_II, x, y, plane, object.getOwner()));
							 break;
						case "divine herb patch iii":
						    player.getActionManager().setAction(new DivineHerblore(DivineHerbsSpots.DIVINE_HERB_III, x, y, plane, object.getOwner()));
							 break;
						case "gate":
						case "large door":
						case "metal door":
		...
		player.setRouteEvent(new RouteEvent(object, new Runnable() {
			...
			public void run() {
				...
				if (itemId >= 1438 && itemId <= 1450) {
					...
					player.getCoalTrucksManager().addCoal(itemId);
				else if (object.getId() == 6045 && (itemId == 453 || itemId == 434 || itemId == 436 || itemId == 438 ||
					 itemId == 440 || itemId == 442 || itemId == 444 || itemId == 447 || itemId == 449 || itemId == 451))
				player.getCoalTrucksManager().addCoal(itemId);
					...
					switch (objectDef.name.toLowerCase()) {
						...
						case "anvil":
							...
							player.getDialogueManager().startDialogue("SmithingD", object, bar);
							break;
						case "furnace":
						case "lava furnace":
							//if (item.getId() == 2357) {//TODO implement accesory smithing into 
							//	AccessorySmithing.openInterface(player);
							    	SmeltingBar bars = Smelting.SmeltingBar.getBar(itemId);
								if(bars != null) { //else nothing interestin happens
									player.getDialogueManager().startDialogue("SmeltingD", object, bars);
							}
							break;
						case "altar":
						...
						case "firepit":
							if (objectDef.containsOption(4, "Add-logs") && Bonfire.addLog(player, object, item))
								return;
							if (objectDef.containsOption(4, "Use") && Bonfire.addLog(player, object, item))
								return;
						case "range":
						case "cooking range":
						case "stove":
